...
- ⚡ **Zero FOUC**: Injects server-rendered `<style id="naki-theme-tokens">` tags for smooth static and SSR page loads.
...
<CardGroup cols={2}>
  ...
  <Card title="Styling Models" icon="ruler-combined" href="/theming/styling-models">
    `BoxDecoration`, `BorderRadius`, `EdgeInsets`, and `TextStyle`.
  </Card>
</CardGroup>
